...
enum HIKProperty
{
   ...
   //@{
	...
	/**	Determines the percentage of its length that the spine is allowed to squash or stretch in order for the ChestEndEffectorId to reach its goal.
		For more information, see ~{ Using Squash 'n' Stretch }~. */
	HIKSnSSpineFreedom,
	...
	/**	Determines the amount of scaling to apply to the Nodes in the neck when the neck is squashed or stretched.
		For more information, see ~{ Using Squash 'n' Stretch }~. */
	HIKSnSScaleNeck,
	/**	Determines the percentage of its length that the neck is allowed to squash or stretch in order for the HeadEffectorId to reach its goal. 
		For more information, see ~{ Using Squash 'n' Stretch }~. */
	HIKSnSNeckFreedom,
